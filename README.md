...
- [Deployment](#deployment)
  ...
  - [GitHub Pages](#github-pages)
    ...
    - [Step 2: Install `gh-pages` and add `deploy` to `scripts` in `package.json`](#step-2-install-gh-pages-and-add-deploy-to-scripts-in-package-json)
    - [Step 3: Deploy the site by running `npm run deploy`](#step-3-deploy-the-site-by-running-npm-run-deploy)
    - [Step 4: Ensure your project’s settings use `gh-pages`](#step-4:-ensure-your-project’s-settings-use-`gh-pages`)
...
- [Troubleshooting](#troubleshooting)
  - [`npm start` doesn’t detect changes](#`npm-start`-doesn’t-detect-changes)
  - [`npm test` hangs on macOS Sierra](#npm-test-hangs-on-macos-sierra)
  - [`npm run build` exits too early](#npm-run-build-exits-too-early)
  - [`npm run build` fails on Heroku](#npm-run-build-fails-on-heroku)
  - [Moment.js locales are missing](#moment-js-locales-are-missing)
